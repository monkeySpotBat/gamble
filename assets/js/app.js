...
function setBet(e, n, t, o){
    ...
    localStorage.setItem("fakeMoney", bankValue);
		document.getElementById('bankSpan').innerText = '' + bankValue.toLocaleString("en-GB") + '';
		document.getElementById('betSpan').innerText = '' + currentBet.toLocaleString("en-GB") + '';
...
function loadBankValue() {
    let storedMoney = localStorage.getItem("fakeMoney");
    bankValue = storedMoney ? parseInt(storedMoney) : 1000; // Falls kein Wert vorhanden ist, auf 1000 setzen
    document.getElementById('bankSpan').innerText = bankValue.toLocaleString("en-GB");
}
